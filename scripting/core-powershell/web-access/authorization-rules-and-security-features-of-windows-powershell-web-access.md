...
users, target computers, and particular Windows PowerShell [session configurations](https://msdn.microsoft.com/en-us/powershell/reference/5.1/microsoft.powershell.core/about/about_session_configurations)
...
computers to a trusted hosts list, see [Remote Management with Server Manager](href="https://technet.microsoft.com/library/dd759202.aspx)
